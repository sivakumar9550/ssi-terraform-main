module "web" {
  source                     = "github.com/sivakumar9550/ssi-terraform-module/tree/main/ssi-up-module-web"
...
module "mail" {
  source                     = "github.com/sivakumar9550/ssi-terraform-module/tree/main/ssi-up-module-mail"
...
module "httpd" {
  source                       = "github.com/sivakumar9550/ssi-terraform-module/tree/main/ssi-up-module-httpd1"
